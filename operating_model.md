...
| Composition | `rules/claim_safety.md`; `rules/proportionality.md` | `prompts/final_response_builder.md` | `sources/source_bundle_template.md` | `tracking/exemplar_index.md` | `.agent/workflows/default_workflow.md` (writing mode) |
